...
namespace DoAnCoSo.Migrations
{
    ...
    [Migration("20250512065915_ngay12_5")]
    partial class ngay12_5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnCoSo.Models.Cang", b =>
                {
                    b.Property<int>("MaCang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaCang"));

                    b.Property<string>("MoTa")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TenCang")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ChiTietCang", b =>
                {
                    b.Property<int>("MaSanPhamID")
                        .HasColumnType("int");

                    b.Property<int>("MaCangID")
                        .HasColumnType("int");

                    b.Property<DateTime?>("NgayNhapCang")
                    ...
                    b.HasKey("MaSanPhamID", "MaCangID");

                    b.HasIndex("MaCangID");

                    b.ToTable("ChiTietCangs");
                });

            modelBuilder.Entity("DoAnCoSo.Models.ChiTietDanhBat", b =>
                {
                    b.Property<int>("MaDuLieuDanhBatID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MaDuLieuDanhBatID", "MaSanPhamID");

                    b.HasIndex("MaSanPhamID");

                    b.ToTable("ChiTietDanhBats");
                });
            ...
            modelBuilder.Entity("DoAnCoSo.Models.DuLieuDanhBat", b =>
                {
                    b.Property<int>("MaDuLieuDanhBat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaDuLieuDanhBat"));

                    b.Property<int?>("MaNguDanID")
                        .HasColumnType("int");

                    b.Property<DateTime>("NgayDanhBat")
                        .HasColumnType("datetime2");

                    b.Property<int>("SoLuongDanhBat")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MaDuLieuDanhBat");

                    b.HasIndex("MaNguDanID");

                    b.ToTable("DuLieuDanhBats");
                });
            ...
            modelBuilder.Entity("DoAnCoSo.Models.NguDan", b =>
                {
                    b.Property<int>("MaNguDan")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaNguDan"));
            ...
            modelBuilder.Entity("DoAnCoSo.Models.VanChuyen", b =>
                {
                    ...
                    b.Property<string>("TrangThaiVanChuyen")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ChiTietCang", b =>
                {
                    b.HasOne("DoAnCoSo.Models.Cang", "Cang")
                        .WithMany("ChiTietCangs")
                        .HasForeignKey("MaCangID")
            ...
            modelBuilder.Entity("DoAnCoSo.Models.ChiTietDanhBat", b =>
                {
                    b.HasOne("DoAnCoSo.Models.DuLieuDanhBat", "DuLieuDanhBat")
                        .WithMany("ChiTietDanhBats")
                        .HasForeignKey("MaDuLieuDanhBatID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DoAnCoSo.Models.DonHang", b =>
                {
                    ...
                    b.HasOne("DoAnCoSo.Models.VanChuyen", "VanChuyen")
                        .WithMany("DonHangs")
            ...
            modelBuilder.Entity("DoAnCoSo.Models.DuLieuDanhBat", b =>
                {
                    b.HasOne("DoAnCoSo.Models.NguDan", "NguDan")
                        .WithMany("DuLieuDanhBats")
                        .HasForeignKey("MaNguDanID")
                        .OnDelete(DeleteBehavior.Restrict);
